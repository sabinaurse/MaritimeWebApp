...
- Create Angular project with ng: `ng new maritimewebapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`maritimewebapp.client.esproj`).
